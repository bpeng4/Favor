...
REVERSE_TRUNC <- 45 # determine from quality plots
...
ggsave("/work/benson/bpeng4/Favor/Plots/Datatracking.png", plot = Datatracking, width = 6, height = 4, dpi = 300)

dir.create("./intermediate/", showWarnings = FALSE)
save(metadata_df, seqtab.nochim, file = "./intermediate/Favor.rda")
